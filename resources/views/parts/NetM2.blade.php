<ul class="nav nav-pills flex-column">
    ...
    <ul class="sub-menu collapse show" id="metraj">
        <li class="nav-item">
            <div class="nav-link">
                <input id="netM2Min" name="netM2" value="{{old('netM2Min')}}" type="number" placeholder="min metrekare">
            </div>
        </li>
        <li class="nav-item">
            <div class="nav-link">
                <input id="netM2Max" name="netM2" value="{{old('netM2Max')}}" type="number" placeholder="max metrekare">
            </div>
        </li>
        <li class="nav-item">
            <div class="nav-link">
