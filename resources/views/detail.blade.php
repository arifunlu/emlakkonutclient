          ...
          <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
            <section id="sectionIcerik" class="row text-center collapse show">
              <div class="btn-group btn-grp-fix" role="group">
                <button type="button" class="btn btn-success active tableheader">GENEL VAZİYET PLANI</button>
                <button type="button" class="btn btn-success tableheader">PARSEL VAZİYET PLANI</button>
                <button type="button" class="btn btn-success tableheader">DAİRE PLANI</button>
              </div>
