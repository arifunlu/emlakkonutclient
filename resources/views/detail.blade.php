  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 p-0">
        <section id="sectionIcerik" class="p-0">
            ...
            <div class="d-flex flex-column align-items-center" style="width: 2rem;">
              ...
              <div class="ws trans" style="margin-top: 16rem;">
                ...
                <div class="d-flex flex-row">
                  <i class="icon-Pointer retrans" style="width: 36px;" onclick="$.setChange('edit');" role="button"></i>
                </div>
              ...
              <div class="ws trans" style="margin-top: 4rem;">
                <div class="ws_left"></div>
                <div class="d-flex flex-row">
                  <i class="icon-Zoom_In retrans" onclick="$.setChange('zoomIn');" role="button"></i>
                  <i class="icon-Fit retrans" onclick="$.setChange('zoomReset');" role="button"></i>
                  <i class="icon-Zoom_Out retrans" onclick="$.setChange('zoomOut');" role="button"></i>
                </div>
                <div class="ws_right"></div>
              </div>
